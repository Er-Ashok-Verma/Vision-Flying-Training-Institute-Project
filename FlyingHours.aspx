<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FlyingHours.aspx.cs" Inherits="Flying_Hour_FlyingHours" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Flying Hours View</title>
                    ...
                    <div class="main-card">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                              ...
                              <!-- Total Flying Hours (styled badge) -->
                       
                           <div class="col-lg-6 col-md-6 col-12">
                                <div class="total-hours-badge">
                                    <i class="fa-regular fa-hourglass"></i> Total Flying Hours :
                                    <span><asp:Label ID="lblTotalHours" runat="server" Text="0" /></span>
                                </div>
                            </div>
                       
                             <!-- Total Eligible Hours (styled badge) -->
                          
                           <div class="col-lg-6 col-md-6 col-12">
                                <div class="total-hours-badge">
                                    <i class="fa-regular fa-hourglass"></i> Total Balance Hours :
                                    <span><asp:Label ID="lblBalanceHours" runat="server" Text="0" /></span>
                                </div>
                            </div>
