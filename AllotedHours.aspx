 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllotedHours.aspx.cs" Inherits="Flying_Hour_Alloted_Hours" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Alloted Hours View</title>
    ...
    <style>
        /* ----- GLOBAL RESET / BODY (matches student registration) ----- */
        * {
            margin: 0;
            padding: 0;
        ...
        /* MAIN CARD (same as registration) */
        .main-card {
            background: white;
            border-radius: 25px;
            padding: 35px;
        ...
        /* TABLE (matching student registration table style) */
        .table {
            min-width: 1000px;
            border-radius: 15px;
            overflow: hidden;
        ...
        /* DataTables overrides – keep consistency */
            ...
            <ContentTemplate>
                <div class="container">
                    ...
                    <div class="main-card">
                        ...
                        <!-- Total Alloted Hours (styled badge) -->
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="total-hours-badge">
                                    <i class="fa-regular fa-hourglass-half"></i> Total Alloted Flying Hours :
                        ...
                        <div class="grid-scroll">
                            <asp:GridView ID="gridview" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Alloted Flying Hours" DataField="Flying_Hrs" />
